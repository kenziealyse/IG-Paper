...
function [] = ThreeCompartmentPS(filename, ...
    ...
    [~,Y] = ode23s(@(t,Y) ThreeCompartmentModel(t,Y,estimates, @dosing_func), tspan_to_save, init_cond);
    ...
    % Save Data Structure
    save(['PS_Results/',filename], '-struct' ,'Fit_Data_Information');
